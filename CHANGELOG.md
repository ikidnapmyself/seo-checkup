...
A second review of PR #1 (2026-08-18) found three regressions against `v0.1-beta` sharing one root — the new `Url`/`UrlResolver` layer was stricter than the transport it fronts and never percent-encoded — closed the same way:
